...
<head>
  ...
  <script type="text/javascript">
    function save(){
    	...
    	$.ajax({
    	    type: "post",
    	    url:"<%=basePath%>user/save.htmls?name="+encodeURI(encodeURI(name))+"&classId="+classId+"&type=0",
    	    ...
    	    success: function(data){
    	    	        ...
    	    	        switch(result)
    	    	        {
    	    	        case 0:alert("保存失败,请稍后再试");break;
    	    	        case 1:alert("保存成功");window.location.href="<%=basePath%>user/teacher.htmls";
    	    	        case 2:alert("姓名已存在");break;
    	    	        }
...
<div class="admin-content-body">
    <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">学生管理</strong> / <small>Student</small></div>
    </div>
